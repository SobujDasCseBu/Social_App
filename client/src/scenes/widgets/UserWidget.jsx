...
import {
 ...
 const UserWidget = ({userId, picturePath}) =>{
   ...
   // console.log(" user  :", user)
    ...
    const {firstName, lastName, occupation, location, viewedProfile, impression, friends} = user
    return (
        <WidgetWrapper>
            <FlexBetween
            gap = '0.5rem'
            ...
            >
               ...
               <Box padding=' 1rem 0'>
                <Typography fontSize='1rem' fontWeight='500' color={main}>
                    Social Profile
                </Typography>
